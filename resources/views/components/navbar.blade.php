<!--
Halaman untuk menampilkan Navigation Bar
-->
...
<nav class="bg-gray-800" x-data="{ isOpen: false }">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <x-nav-link href="/produk" :active="request()->is('produk')">Product</x-nav-link>
              <x-nav-link href="/blog" :active="request()->is('blog')">Blog</x-nav-link>
              <x-nav-link href="/service" :active="request()->is('service')">Services</x-nav-link>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
        ...
        <x-nav-mobile href="/produk" :active="request()->is('produk')">Products</x-nav-mobile>
        <x-nav-mobile href="/blog" :active="request()->is('blog')">Blog</x-nav-mobile>
        <x-nav-mobile href="/service" :active="request()->is('service')">Services</x-nav-mobile>
        <x-nav-mobile href="/contact" :active="request()->is('contact')">Contact</x-nav-mobile>
        <x-nav-mobile href="/about" :active="request()->is('about')">About Us</x-nav-mobile>
      </div>
